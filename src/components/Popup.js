    ...
    return (
      <PopupBox>
        ...
        <div className="part-2">
          ...
          <p><b>기획 및 디자인</b> :
            <a href="https://www.figma.com/file/elnXUa0RLvAtaT19DbnMdJ/%EC%8A%A4%ED%84%B0%EB%94%94?type=design&node-id=1%3A2&mode=design&t=XXMnErKGHhKL4G29-1" target="_blank" rel="noopener noreferrer"> 피그마</a>
          </p>
          <p className="code df aic"><b>코드&nbsp;</b>:&nbsp;
            ...
            <a href="https://github.com/yurimeeee/Diet-tip" target="_blank" rel="noopener noreferrer">&nbsp;깃허브</a>
          </p>
